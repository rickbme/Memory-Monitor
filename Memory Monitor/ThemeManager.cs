                       ...
                       Color MenuBackground, Color MenuText) GetCurrentColors()
        {
            if (CurrentTheme == Theme.Dark)
            {
                return (DarkTheme.FormBackground, DarkTheme.ControlBackground, DarkTheme.TextPrimary,
                        ...
                        DarkTheme.CPUColor, DarkTheme.GPUColor, DarkTheme.ListViewBackground,
                        DarkTheme.ListViewText, DarkTheme.ListViewGrid, DarkTheme.MenuBackground,
                        DarkTheme.MenuText);
            }
            else
            {
                return (LightTheme.FormBackground, LightTheme.ControlBackground, LightTheme.TextPrimary,
                        ...
                        LightTheme.CPUColor, LightTheme.GPUColor, LightTheme.ListViewBackground,
                        LightTheme.ListViewText, LightTheme.ListViewGrid, LightTheme.MenuBackground,
                        LightTheme.MenuText);
            }
        }
